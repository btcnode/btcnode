Contributing to Btcnode Core
============================

The Btcnode Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/btcnode-project/btcnode/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Btcnode Core project, and is not to be
confused with overall Btcnode Network Protocol consensus changes.

Whether a pull request is merged into Btcnode Core rests with the project merge
...
Patches that change Btcnode consensus rules are considerably more involved than
...
Where a patchset proposes to change the Btcnode consensus, it must have been
...
The project leader is the release manager for each Btcnode Core release.
