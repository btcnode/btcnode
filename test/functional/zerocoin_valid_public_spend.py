...
from fake_stake.base_test import Btcnode_FakeStakeTest

class zBTNValidCoinSpendTest(Btcnode_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBTNs..." % DENOM_TO_USE)
