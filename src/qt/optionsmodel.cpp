...
// Wallet
    ...
    if (settings.contains("nAnonymizeBtcnodeAmount"))
        SoftSetArg("-anonymizebtcnodeamount", settings.value("nAnonymizeBtcnodeAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in btcnode.cpp during shotdown to also remove the window positions
