...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case BTN:
        return QString("btcnode");
    case mBTN:
        return QString("mbtcnode");
    case uBTN:
        return QString::fromUtf8("ubtcnode");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BTN:
            return QString("tBTN");
        case mBTN:
            return QString("mtBTN");
        case uBTN:
            return QString::fromUtf8("μtBTN");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BTN:
            return QString("BTN");
        case mBTN:
            return QString("Milli-BTN (1 / 1" THIN_SP_UTF8 "000)");
        case uBTN:
            return QString("Micro-BTN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BTN:
            return QString("TestBTNs");
        case mBTN:
            return QString("Milli-TestBTN (1 / 1" THIN_SP_UTF8 "000)");
        case uBTN:
            return QString("Micro-TestBTN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
