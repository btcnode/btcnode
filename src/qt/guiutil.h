...
/** Utility functions used by the Btcnode Qt UI.
 */
namespace GUIUtil
{
...
// Render Btcnode addresses in monospace font
...
// Parse "btcnode:" URI into recipient object, return true on successful parsing
