                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBTNPathCustom = GetArg("-zbtnbackuppath", "");
    ...
    if(!strzBTNPathCustom.empty()) {
        ui->wallet_customzbtnbackuppath->setText(QString::fromStdString(strzBTNPathCustom));
        ui->wallet_customzbtnbackuppath_label->setVisible(true);
        ui->wallet_customzbtnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBTNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Btcnode RPC console.") + "<br>" +
