...
/* Btcnode GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Btcnode"
#define QAPP_ORG_DOMAIN "btcnode.org"
#define QAPP_APP_NAME_DEFAULT "Btcnode-Qt"
#define QAPP_APP_NAME_TESTNET "Btcnode-Qt-testnet"
