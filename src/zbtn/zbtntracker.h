...
#ifndef Btcnode_ZBTNTRACKER_H
#define Btcnode_ZBTNTRACKER_H
...
public:
    CzBTNTracker(std::string strWalletFile);
    ~CzBTNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBTNWallet* zBTNWallet = NULL);
