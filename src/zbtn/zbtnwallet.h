...
#ifndef Btcnode_ZBTNWALLET_H
#define Btcnode_ZBTNWALLET_H
...
public:
    CzBTNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBTN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBTN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
