...
/**
 * Btcnode RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZbtnSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzbtnseed(const UniValue& params, bool fHelp);
extern UniValue getzbtnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbtn(const UniValue& params, bool fHelp);
extern UniValue dzbtnstate(const UniValue& params, bool fHelp);
