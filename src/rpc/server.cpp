...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Btcnode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Btcnode features */
        {"btcnode", "listmasternodes", &listmasternodes, true, true, false},
        {"btcnode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"btcnode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"btcnode", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"btcnode", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"btcnode", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"btcnode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"btcnode", "masternodedebug", &masternodedebug, true, true, false},
        {"btcnode", "startmasternode", &startmasternode, true, true, false},
        {"btcnode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"btcnode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"btcnode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"btcnode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"btcnode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"btcnode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"btcnode", "preparebudget", &preparebudget, true, true, false},
        {"btcnode", "submitbudget", &submitbudget, true, true, false},
        {"btcnode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"btcnode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"btcnode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"btcnode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"btcnode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"btcnode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"btcnode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"btcnode", "checkbudgets", &checkbudgets, true, true, false},
        {"btcnode", "mnsync", &mnsync, true, true, false},
        {"btcnode", "spork", &spork, true, true, false},
        {"btcnode", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbtnseed", &getzbtnseed, false, false, true},
        {"zerocoin", "setzbtnseed", &setzbtnseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbtn", &searchdzbtn, false, false, true},
        {"zerocoin", "dzbtnstate", &dzbtnstate, false, false, true},
...
{
    return "> btcnode-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30743/\n";
}
