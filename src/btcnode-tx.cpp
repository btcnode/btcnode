...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Btcnode Core btcnode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  btcnode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded btcnode transaction") + "\n" +
                               "  btcnode-tx [options] -create [commands]   " + _("Create hex-encoded btcnode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded btcnode transaction
