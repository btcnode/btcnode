...
RESOURCES += src/qt/btcnode.qrc src/qt/btcnode_locale.qrc

TRANSLATIONS += src/qt/locale/btcnode_bg.ts \
                src/qt/locale/btcnode_de.ts \
                src/qt/locale/btcnode_en.ts \
                src/qt/locale/btcnode_es.ts \
                src/qt/locale/btcnode_fi.ts \
                src/qt/locale/btcnode_fr.ts \
                src/qt/locale/btcnode_it.ts \
                src/qt/locale/btcnode_ja.ts \
                src/qt/locale/btcnode_pl.ts \
                src/qt/locale/btcnode_pt.ts \
                src/qt/locale/btcnode_ru.ts \
                src/qt/locale/btcnode_sk.ts \
                src/qt/locale/btcnode_sv.ts \
                src/qt/locale/btcnode_vi.ts \
                src/qt/locale/btcnode_zh_CN.ts \
                src/qt/locale/btcnode_zh_TW.ts
